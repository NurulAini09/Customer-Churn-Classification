...
@section('content')
  <div class="sticky top-0 z-20 -mx-5 mb-3 bg-[#F3F6FA] px-5 py-3 sm:-mx-6 sm:px-6">
    ...
    <p class="mt-1 text-xs font-medium text-[#64748B]">Arsitektur aplikasi klasifikasi churn pelanggan</p>
  </div>
    ...
    <section class="rounded-md border border-[#D8E2EC] bg-white">
      ...
      <div class="p-4">
        <p class="max-w-3xl text-[13px] leading-6 text-[#475569]">
          ...
          Laravel menangani halaman, form, hasil klasifikasi, dan riwayat. FastAPI menangani proses machine learning
          menggunakan model Random Forest yang dioptimasi PSO.
        </p>

        <div class="mt-5 grid gap-3 md:grid-cols-2">
          @foreach ([
            ['title' => 'Laravel Frontend', 'body' => 'Dashboard, form klasifikasi, routing, dan riwayat klasifikasi.'],
            ['title' => 'FastAPI Backend', 'body' => 'Endpoint klasifikasi, validasi payload, dan response JSON.'],
            ['title' => 'ML Layer', 'body' => 'Load model dari folder khusus dan menjalankan klasifikasi.'],
            ['title' => 'Database', 'body' => 'Menyimpan riwayat klasifikasi untuk analisis ulang.'],
          ] as $card)
